...
## [Unreleased](https://github.com/Art4/WP-Requests-PSR18-Adapter/compare/1.4.1...HEAD)

Nothing yet.

## [1.4.1 - 2026-05-09](https://github.com/Art4/WP-Requests-PSR18-Adapter/compare/1.4.0...1.4.1)

### Fixed

- Let HttpClient pass URL-encoded body as raw string to preserve repeated params

## [1.4.0 - 2026-03-26](https://github.com/Art4/WP-Requests-PSR18-Adapter/compare/1.3.0...1.4.0)

### Added

- Implement pointer support in `Art4\Requests\Psr\StringBasedStream`.
